package reserveNewPageByAppium;
 ...
 */
    ...
    @もし("^\"([^\"]*)\"によってはナビゲータボタンをクリックする$")
    public void naviButtonClick(String orientation) throws InterruptedException {
    	String selector = "a.btn.btn-navbar";
